              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-3xl font-semibold text-gray-900">18</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center">
                    ...
                    />
                    <div className="ml-4">
                      <p className="text-sm font-medium text-gray-900">Complete Project Presentation</p>
                      <div className="mt-1">
                        <p className="text-sm text-gray-500">Prepare slides and documentation for the client meeting</p>
                        <p className="text-xs text-gray-400 mt-1">Due: Dec 15, 2023</p>
                      </div>
